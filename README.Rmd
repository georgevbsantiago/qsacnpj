...
*OBS: Os arquivos descompactados tem mais de 85Gb. Verifique se há espaço suficiente no seu HD*

4 - Renomei o arquivo para um nome mais amigável, acrescentando a extensão '.txt' no final. Ex: 'cnpj_arq_L00001.txt'

5 - IMPORTANTE: Crie uma pasta específica para armazenar somente os arquivos '.txt'.
