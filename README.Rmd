...
A base de dados do CNPJ já tratada está disponível nos link abaixo. Contudo, é bom destacar que essa base de dados foi criada com a primeira versão do pacote, logo, pode haver algumas inconsistência, a exemplo da presença de linhas em branco. Ainda estamos investigando essa questão, mas tudo indica que são inconsistência do arquivo disponibilizado pela Receita Fedeal.
