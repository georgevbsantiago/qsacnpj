...
- Verificar porque o arquivo CSV e o SQLite criados têm algumas linhas em branco no data frame.
Analisar se são inconsistências da base de dados ou da função;

- Analisar o Dicionário de Dados da Receita Federal para propor uma melhor extração dos
CNAEs Secundários. Verificar se o problema é no Dicinário de Dados ou na Base de Dados;
