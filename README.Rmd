...
Resultado esperado: No teste realizado sem aplicar o filtro 'localizar\_cnpj', o código executou com sucesso o tratamento e organização de todos os dados no tempo de 4 horas, usando um notebook com processador i7 5ª Geração, 16Gb DDR3 e disco HDD.
...
-   Implementar uma função para verificar se os CNPJ na variável 'localizar\_cnpj' são válidos;
